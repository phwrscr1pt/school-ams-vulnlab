...
<div class="card"><h1>ข้อมูลส่วนบุคคล</h1>
...
<div class="card"><h1>ข้อมูลผลการเรียน</h1>
  <p><b>เกรดเฉลี่ย:</b> <?=htmlspecialchars($st['gpa'])?></p>
</div>
<div class="card"><div class="debug"><b>DEBUG SQL:</b> <?=htmlspecialchars($sql)?></div></div>
<?php else: ?>
